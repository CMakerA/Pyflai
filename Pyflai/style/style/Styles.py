...
button_idle = SingleStyle(Colors.flat_gray, BorderStyle(Colors.transparent, 1), Fonts.default, Colors.transparent, "ButtonIdle")
...
text_box_focused = SingleStyle(Colors.flat_cream_yellow, BorderStyle(Colors.flat_blue, 2), Fonts.default, Colors.flat_gray)
